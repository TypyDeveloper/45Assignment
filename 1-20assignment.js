...
console.log("\nQuestion 15\n");
let guestlists = ['hala', 'ayan', 'ashfaq', 'amir', 'ali'];
let notcome = "hala";
...
//• Store the locations in a array. Make sure the array is not in alphabetical order.
let locations = ["Malysia", "Singapore", "Islamabad"];
// Print your array in its original order.
...
let food = ["Pasta", "Lasania", "Noodles", "Biryani", "Pulao"];
console.log(food.forEach(foodies => {
    console.log(foodies);
}));
